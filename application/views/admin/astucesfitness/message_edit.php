    ...
    <div class="card">
      ...
      <div class="body">
        <div class="row clearfix">
          ...
          <?php endif; ?>
          <?php echo form_open(base_url('admin/astucesfitness/edit/'.$user['idalertes']), 'class="form-horizontal"')?> 
            <div class="row clearfix">
            ...
            <div class="row clearfix">
                ...
                <div class="col-lg-8 col-md-10 col-sm-8 col-xs-7">
                    <div class="form-group">
                        <div class="form-line">
                            <input type="text" id="dateheureenvoi" name="dateheureenvoi" value="<?= $user['dateheureenvoi']; ?>" class="form-control">
                        </div>
                    </div>
                </div>
            </div>
