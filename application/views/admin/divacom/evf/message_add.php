...
<div class="card">
  <div class="header">
    ...
    <a href="<?= base_url('admin/astucesfitness/message'); ?>" class="btn bg-deep-orange waves-effect pull-right">Liste des messages</a>
  </div>
  <div class="body">
    <div class="row clearfix">
     
       
      <?php echo form_open(base_url('admin/astucesfitness/add'), 'class="form-horizontal"');  ?> 
        <div class="row clearfix">
 	...
 	<div class="row clearfix">
            ...
            <div class="col-lg-4 col-md-2 col-sm-2 col-xs-2">
                <div class="form-group">
                    <div class="form-line">
                        <input type="date" id="dateheureenvoi" name="dateheureenvoi" form-control">
                    </div>
                </div>
            </div>
        </div>
 	...
 	<div class="row clearfix">
            <div class="col-lg-2 col-md-2 col-sm-4 col-xs-5 form-control-label">
                <label for="dateheureenvoih">Heure d'envoi</label>
            </div>
            <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2">
                <div class="form-group">
                    <div class="form-line">
                        <input type="time" id="dateheureenvoih" name="dateheureenvoih" class="form-control">
                    </div>
                </div>
            </div>
        </div>
