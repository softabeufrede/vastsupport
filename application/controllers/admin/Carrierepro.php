...
class Carrierepro extends MY_Controller {
	public function __construct(){
		...
		public function message(){
			$data['view'] = 'admin/carrierepro/message_list';
			$this->load->view('layout', $data);
		}

		
		public function statistique(){
			$data['view'] = 'admin/carrierepro/statistique_list';
			$this->load->view('layout', $data);
		}

		
		public function visuel(){
			$data['view'] = 'admin/carrierepro/visuel_list';
			$this->load->view('layout', $data);
		}
		...
		public function alerte(){
			$data['view'] = 'admin/carrierepro/alerte_list';
			$this->load->view('layout', $data);
		}
