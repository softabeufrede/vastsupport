...
class Emploijeunes extends MY_Controller {
	public function __construct(){
		...
		public function message(){
			$data['view'] = 'admin/emploijeunes/message_list';
			$this->load->view('layout', $data);
		}

		
		public function statistique(){
			$data['view'] = 'admin/emploijeunes/statistique_list';
			$this->load->view('layout', $data);
		}

		
		public function visuel(){
			$data['view'] = 'admin/emploijeunes/visuel_list';
			$this->load->view('layout', $data);
		}
		...
		public function alerte(){
			$data['view'] = 'admin/emploijeunes/alerte_list';
			$this->load->view('layout', $data);
		}
