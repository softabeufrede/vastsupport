...
class Agendaevents extends MY_Controller {
	public function __construct(){
		...
		public function message(){
			$data['view'] = 'admin/agendaevents/message_list';
			$this->load->view('layout', $data);
		}

		
		public function statistique(){
			$data['view'] = 'admin/agendaevents/statistique_list';
			$this->load->view('layout', $data);
		}

		
		public function visuel(){
			$data['view'] = 'admin/agendaevents/visuel_list';
			$this->load->view('layout', $data);
		}
		...
		public function alerte(){
			$data['view'] = 'admin/agendaevents/alerte_list';
			$this->load->view('layout', $data);
		}
